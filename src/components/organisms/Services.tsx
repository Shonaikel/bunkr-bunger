...
export default function Services({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="flex">
        {SERVICES.map((s) => (
          <div key={s.title} className="flex-1 flex flex-col items-center gap-[12px] bg-[#131718] px-[clamp(0.75rem,1.5vw,1.5rem)] py-[clamp(1.25rem,2vw,2rem)] min-h-[clamp(16rem,22vw,0.5rem)] border-0 outline-none">
