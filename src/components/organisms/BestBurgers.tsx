    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img
          alt=""
          src={BG_BLUR}
          className="absolute inset-0 w-full h-full object-center object-cover blur-[10px]"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black via-transparent to-black" />
      </div>

      {/* Content — flex column, centered */}
      <div className="relative z-10 min-h-[inherit] max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1700px] mx-auto px-[clamp(1rem,5vw,6.25rem)] flex flex-col items-center justify-between gap-[clamp(0.75rem,1.5vw,1.25rem)] pt-0 pb-[clamp(1.5rem,3vw,2.25rem)]">

        {/* Title with decorative lines */}
        <div className="flex items-center justify-center gap-[clamp(0.5rem,1.5vw,1rem)] w-full">
          <div className="shrink-0 h-px flex-1 max-w-[420px]">
        ...
        <a
          href="/menu"
          className="h-[46px] px-[32px] flex items-center justify-center bg-[#f3731c] rounded-[5px] hover:opacity-90 transition-opacity"
        >
